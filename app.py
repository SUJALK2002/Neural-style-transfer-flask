...
encoder = VGGEncoder(
    r'E:\ai-nst-project-main\ai-nst-project-main\NST_Code\vgg_normalised.pth'
).to(device)
...
decoder.load_state_dict(
    torch.load(
        r'E:\ai-nst-project-main\ai-nst-project-main\NST_Code\experiment\final_exp\decoder_final.pth',
        map_location=device
    )
)
